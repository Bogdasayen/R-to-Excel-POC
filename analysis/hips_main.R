...
hips_inputs <- input_parameters$new(v_names = c(paste0("Probability_1st_revision_", treatment_names),
                                                "Probability_2nd_revision", rep("Probability_death", 3),
                                                paste0("cost_1st_revision_", treatment_names),
                                                "cost_2nd_revision", "cost_higher_revision",
                                                paste0("state_utility_", state_names),
                                                paste0("implant_cost_", treatment_names)),
                                    v_descriptions = c(paste0("Probability of 1st revision if using ", treatment_names, ", follows a normal distribution"),
                                                       "Probability of 2nd revision, follows a normal distribution",
                                                       rep("Probability of death, follows a normal distribution", 3),
                                                       paste0("Cost of revision of post THR state if using ", treatment_names, ", follows a normal distribution, with fixed revision cost and normally distributed probability"),
                                    ...
                                    v_type = c("transition_probability", "transition_probability", "transition_probability", "transition_probability", 
                                               "transition_probability", "transition_probability", "transition_probability", "transition_probability",
                                               "cost", "cost", "cost", "cost", "cost", "cost",
                                               "utility", "utility", "utility", "utility", 
                                               "one_off_cost", "one_off_cost", "one_off_cost", "one_off_cost"),
                                    v_distributions = c("normal", "normal", "normal", "normal", "normal", "normal", "normal", "normal", 
                                                        "normal", "normal", "normal", "normal", "normal", "normal",
                                                        "normal", "normal", "normal", "fixed", "fixed", "fixed", "fixed", "fixed"),
                                    m_hyperparameters = matrix(c(c(rbind(
                                    ...
                                    v_treatment = c(1, 2, 3, 4, NA, NA, NA, NA, 1, 2, 3, 4, NA, NA, NA, NA, NA, NA, 1, 2, 3, 4),
                                    v_state = c(1, 1, 1, 1, 2, 1, 2, 3, 1, 1, 1, 1, 2, 3, 1, 2, 3, 4, NA, NA, NA, NA))


# Define the Markov hips model
markov_hips <- markov_model$new(n_states = 4,
                                n_cycles = 30,
                                cycle_length = 1,
                                n_samples = 1000,
                                n_treatments = 4,
...
write.csv(markov_hips$generate_results_table(), file = "output/results_table_hips.csv")
...
# parameter headings
markov_hips$export_to_excel(wb_filename = "output/test_output_1_1.xlsm")
